...
<div class="d-flex justify-content-between mb-3">
    ...
    <a href="{{ route('organizer.criteria.setup') }}" class="add-criteria-setup-btn btn btn-primary">
...
<div class="row mb-3 px-4">
    <div class="col-md-9">
        <form action="{{ route('organizer.criteria.list') }}" method="GET" class="d-flex">
            <div class="input-group">
                ...
                @if(request('search'))
                    <a href="{{ route('organizer.criteria.list') }}" class="btn btn-outline-primary">
    ...
    <div class="col-md-3 text-end">
        <div class="btn-group">
            <a href="{{ route('organizer.criteria.list', array_merge(['sort' => 'newest'], request()->except('sort'))) }}" 
               class="btn btn-outline-primary btn-sm {{ request('sort', 'newest') === 'newest' ? 'active' : '' }}">
                Newest First
            </a>
            <a href="{{ route('organizer.criteria.list', array_merge(['sort' => 'oldest'], request()->except('sort'))) }}" 
        ...
        <div class="criteria-card mb-4" style="border: 0.5px solid gray; border-radius: 15px;">
            <div class="criteria-header p-3">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('organizer.criteria.edit', $criteriaData['id']) }}" class="btn btn-primary btn-sm me-2">
                        <i class="ri-edit-box-line"></i> Edit
                    </a>
                    <a href="{{ route('organizer.criteria.delete', $criteriaData['id']) }}" 
