...
<div class="p-5">
    ...
    <form action="{{ route('organizer.criteria.update', $criteria['id']) }}" method="POST" id="criteriaForm">
        @csrf
        @method('PUT')
        ...
        <div class="form-group text-center">
            <button type="button" class="btn-cancel" onclick="window.location.href='{{ route('organizer.criteria.list') }}'">Cancel</button>
