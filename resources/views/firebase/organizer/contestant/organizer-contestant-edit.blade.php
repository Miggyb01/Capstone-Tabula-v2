...
<div class="contestant-setup-form-container">
    <div class="event-setup-form-header  justify-content-center">
        <div class="event-icon-container  align-items-center">
            ...
            <span>Organizer Contestant Edit</span>
        </div>
    </div>
    @if(session('status'))
    ...
    <form action="{{ route('organizer.contestant.update', $id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group text-center">
            <button type="button" class="btn-cancel" onclick="window.location.href='{{ route('organizer.contestant.list') }}'">Cancel</button>
