...
<div class="d-flex justify-content-between mb-3">
    ...
    <a href="{{ route('organizer.contestant.setup') }}" class="add-criteria-setup-btn btn btn-primary">
...
<div class="row mb-3 px-4">
    <div class="col-md-3">
        <form action="{{ route('organizer.contestant.list') }}" method="GET" class="d-flex">
    ...
    <div class="col-md-6">
        <form action="{{ route('organizer.contestant.list') }}" method="GET" class="d-flex">
            ...
            <div class="input-group">
                ...
                @if(request('search'))
                    <a href="{{ route('organizer.contestant.list', ['event_filter' => request('event_filter')]) }}" class="btn btn-outline-primary">
    ...
    <div class="col-md-3 text-end">
        <div class="btn-group">
            <a href="{{ route('organizer.contestant.list', array_merge(['sort' => 'newest', 'event_filter' => request('event_filter')], request()->except('sort'))) }}" 
               class="btn btn-outline-primary btn-sm {{ request('sort', 'newest') === 'newest' ? 'active' : '' }}">
                Newest First
            </a>
            <a href="{{ route('organizer.contestant.list', array_merge(['sort' => 'oldest', 'event_filter' => request('event_filter')], request()->except('sort'))) }}" 
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            <a href="{{ route('organizer.contestant.edit', $contestant['id']) }}" class="btn btn-primary btn-sm me-2">
                                <i class="ri-edit-box-line"></i> Edit
                            </a>
                            <a href="{{ route('organizer.contestant.delete', $contestant['id']) }}" 
