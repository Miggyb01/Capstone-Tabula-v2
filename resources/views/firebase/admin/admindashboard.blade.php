    ...
    <div class="container-fluid">
        <div class="mb-3">
            ...
            <div class="col-12 col-md-4">
                    <a href="{{ route('admin.event.list') }}" class="text-decoration-none">
                ...
                <div class="col-12 col-md-4">
                    <a href="{{ route('admin.judge.list') }}" class="text-decoration-none">
                        <div class="card border-0">
                            <div class="card-body py-4">   
                                <div class="icon-container mt-2">
                ...
                <div class="col-12 col-md-4">
                    <a href="{{ route('admin.contestant.list') }}" class="text-decoration-none">
                        <div class="card border-0">
                            <div class="card-body py-4">
                                <div class="icon-container mt-2">
