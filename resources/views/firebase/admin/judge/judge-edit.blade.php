...
<div class="contestant-setup-form-container">
    ...
    <form action="{{ route('admin.judge.update', $key) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group text-center mt-4">
            <form action="{{ route('admin.judge.list') }}" method="get">
                <button type="submit" class="btn-cancel">Cancel</button>
            </form>
            <button type="submit" class="btn-add ">Update</button>
            <form action="{{ route('admin.judge.reset-password', $key) }}" method="GET" style="display: inline;">
