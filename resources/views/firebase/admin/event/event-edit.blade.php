...
<div class="event-setup-form-container">
        ...
        <form action="{{ route('admin.event.update', $key) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group text-center">
                <button type="button" class="btn-cancel mr-2" onclick="window.location.href='{{ route('admin.event.list') }}'">Cancel</button>
