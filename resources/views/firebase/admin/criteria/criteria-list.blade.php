        ...
        <div class="criteria-card" style="border: 0.5px solid gray; border-radius: 15px; ">
            <div class="criteria-header"  >
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin.criteria.edit', $criteriaId) }}" class="btn btn-primary btn-sm me-2">
                        <i class="ri-edit-box-line"></i> Edit
                    </a>
                    <a href="{{ route('admin.criteria.delete', $criteriaId) }}" class="btn btn-danger btn-sm">
